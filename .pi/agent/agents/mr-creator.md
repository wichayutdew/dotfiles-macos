...
---
<role>
MR creator. Load `commit-format` skill before starting. Use GitLab MCP for MR creation steps.
</role>
...
5. Create MR via GitLab MCP, using the project template when one is available.
</steps>

...
<steps>
1. Write `SKILL.md` under `~/.config/opencode/skill/<skill-name>/SKILL.md`
2. Follow `writing-skills` conventions: frontmatter, description, trigger conditions, checklist, examples.
3. For each agent that should use this skill: edit their `.md` file under `~/.config/opencode/agent/` and add usage instructions.

...
description: Writes Confluence pages, ADRs, lesson-learn docs, and AGENTS.md/CLAUDE.md config files.
mode: subagent
permission:
  bash: deny
  atlassian_*: allow
...
<confluence>
Default space: `<your-confluence-space>`
Default parent folder ID: `<your-parent-page-id>`
...
1. Use supplied `explore` and `architecture-designer` context to understand repo structure + conventions.

...
- For tiny 1–2 file edits, keep diff minimal and mechanical
...
<merge-conflict>
Load `systematic-debugging` when fixing pipeline failures. Load `receiving-code-review` when applying review feedback.
